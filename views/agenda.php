  ...
  <table class="table table-striped">
    ...
    <tbody>
      <?php foreach ($areas as $area) : ?>
        <tr>
          <th scope="row"c lass="d-flex flex-column align-items ">
            <a class="mb-3" href="?path=agenda&area=<?php echo $area->id; ?>"><?php echo $area->descricao; ?></a>
          <div class= "p-3">
            <a href='?path=form&type=area&id=<?= $area->id ?>' type="button" class="btn btn-outline-warning btn-sm" id="editTemp">Editar</a>
          </div>
          <div class= "p-3 align-items-end">
          <a type="button" href="?path=delete&id=<?=$area->id?>&type=area" class="btn btn-outline-danger btn-sm">Deletar</a>
          </div>
        </th>
          <?php for ($m = $mInicial; $m <= $mFinal; $m++) : ?>
            <td>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form method="$_POST">
                                        ...
                                        <a  href='?path=form&type=melhoria&id=<?= $melhoria->id ?>' type="button" class="btn btn-outline-warning" id="editTemp">Editar</a>
                                      </form>

                                    </div>
                                    <div class="modal-footer">
                                          
                                      <a type="button" href="?path=delete&id=<?=$melhoria->id?>&type=melhoria" class="btn btn-outline-danger">Delete</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
